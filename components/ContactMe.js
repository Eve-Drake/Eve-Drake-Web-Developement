  ...
  return (
    <div className='h-screen'>
      ...
      <div className='grid grid-cols-1 gap-6 md:grid-cols-4'>
        <aside className='col-span-2 text-justify p-2 m-2'>
          <p>If you’re interested in my work and would like to contact me, you can send me an email at: contact.evedrake@gmail.com</p>
          <p>Or feel free to use the attached form and I will get back to you shortly.</p>
        </aside>
      </div>
      <div className='col-span-2 text-justify p-2 m-2'>
        <form onSubmit={onSubmit}>
          <label className="block mt-2 text-sm font-medium text-DARK dark:text-GREY">Name</label>
          <input 
            type="text" 
            name="from_name"
          ...
          <label className="block mt-2 text-sm font-medium text-DARK dark:text-GREY">Message</label>
          <textarea 
            name="message"
        ...
        <div className={showSent? 'w-full inset-0' : 'hidden'}>
